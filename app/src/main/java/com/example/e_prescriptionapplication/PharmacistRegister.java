    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (registNo.length() != 4) {
                    mRegistNo.setError("Registration Number must be 4 characters");
                    return;
                }
                ...
                fAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(PharmacistRegister.this, "User Created.", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(PharmacistRegister.this, "Error!!!" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
